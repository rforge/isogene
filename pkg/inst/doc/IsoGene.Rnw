...
<<IsoPlot, fig = TRUE, include = FALSE, width=9, height=5>>=
...
<<IsopvaluePlot, fig=TRUE, include=FALSE>>=
...
<<IsoBHPlot,fig=TRUE, include=FALSE>>=
...
<<IsoSAMPlotOutput, fig=TRUE, include = FALSE>>=
